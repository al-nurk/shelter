...
popup.addEventListener("click", function (e) {
  if (e.target.classList.contains("popup-container") || e.target.classList.contains("popup-wrapper")) {
    popup.classList.remove("fade-in");
    popup.classList.add("fade-out");
...
let paginatorButtonRight = document.querySelector(".slider__arrow-button_right");
let paginatorButtonLeft = document.querySelector(".slider__arrow-button_left");

let paginatorButtonLeftLast = document.querySelector(".slider__arrow-button_left-last");
let paginatorButtonRightLast = document.querySelector(".slider__arrow-button_right-last");
